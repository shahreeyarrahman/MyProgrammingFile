...
redGradient.addColorStop(1, 'rgba(79, 209, 197, 0.1)'); // End color

// Create gradient for blue line
const blueGradient = ctx.createLinearGradient(0, 0, 0, 400);
blueGradient.addColorStop(0, 'rgba(0, 0, 0, 0.1)'); // Start color
blueGradient.addColorStop(1, 'rgba(0, 0, 10, 0.1)'); // End color
  ...
  options: {
    ...
    scales: {
      ...
      yAxes: [{
        ...
        gridLines: {
          color: 'rgba(255, 255, 255, 0.5)', // Change grid line color to white with opacity
